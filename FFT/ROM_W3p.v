...
//      
//      name:			High Speed/Density Diffusion ROM Generator
//           			TSMC CL018G Process
//      version:		2004Q4V1
//      comment:		
//      configuration:	 -instname "ROM_W3p" -words 256 -bits 32 -frequency 200 -ring_width 2 -code_file "W3p.txt" -mux 16 -drive 3 -top_layer met6 -power_type rings -horiz met3 -vert met4 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND
//
//      Verilog model for Synchronous Single-Port Rom
//
//      Instance Name:  ROM_W3p
//      Words:          256
//      Word Width:     32
//
//      Creation Date:  2025-11-22 02:48:17Z
//      Version: 	2004Q4V1
//
...
initial 
	$readmemb("ROM_W3p_verilog.rcf", mem );
